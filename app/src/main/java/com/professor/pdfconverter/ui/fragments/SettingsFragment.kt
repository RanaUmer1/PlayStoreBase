...
class SettingsFragment : Fragment() {
    ...
    private fun updateCurrentLanguage() {
        ...
        val savedLanguageId = appPreferences.getInt(com.professor.pdfconverter.app.AppPreferences.LANGUAGE_ID)
    ...
    private fun getAvailableLanguages(): List<com.professor.pdfconverter.model.LanguageModel> {
        return listOf(
            com.professor.pdfconverter.model.LanguageModel(1, R.drawable.flag_arabic, getString(R.string.arabic), "ar"),
            ...
            com.professor.pdfconverter.model.LanguageModel(7, R.drawable.flag_hindi, getString(R.string.hindi), "hi"),
            com.professor.pdfconverter.model.LanguageModel(8, R.drawable.flag_russia, getString(R.string.russian), "ru"),
            com.professor.pdfconverter.model.LanguageModel(
                9,
            ...
            com.professor.pdfconverter.model.LanguageModel(11, R.drawable.flag_turkey, getString(R.string.turkish), "tr")
        )
    }
